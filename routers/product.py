...
def modProduct(id: str, product: Product):
    ...
    cursor.execute("UPDATE `Products` SET destino = %s, subtitulo = %s, date = %s, days = %s, nights = %s, regimen = %s, transporte = %s, periodo = %s, paquete = %s, descripcion = %s, moneda = %s, precio = %s, adicional = %s, image = %s, desde = %s, hotel = %s, incluye = %s, incluye2 = %s, incluye3 = %s, incluye4 = %s, observaciones = %s, observaciones2 = %s, observaciones3 = %s, itinerario = %s, itinerario2 = %s, itinerario3 = %s, itinerario4 = %s, itinerario5 = %s, itinerario6 = %s, itinerario7 = %s, itinerario8 = %s, tarifas = %s, tarifas2 = %s, tarifas3 = %s, tarifas4 = %s WHERE id = %s", (product.destino, product.subtitulo, product.date, product.days, product.nights, product.regimen, product.transporte, product.periodo, product.paquete, product.descripcion, product.moneda, product.precio, product.adicional, product.image, product.desde, product.hotel, product.incluye, product.incluye2, product.incluye3, product.incluye4, product.observaciones, product.observaciones2, product.observaciones3, product.itinerario, product.itinerario2, product.itinerario3, product.itinerario4, product.itinerario5, product.itinerario6, product.itinerario7, product.itinerario8, product.tarifas, product.tarifas2, product.tarifas3, product.tarifas4, id))
    connection.commit()
